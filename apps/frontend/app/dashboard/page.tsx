		...
		return (
			<div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-900 p-4">
				<div className="text-center p-8 bg-white dark:bg-gray-800 rounded-xl shadow-lg">
					<h2 className="text-xl font-bold text-gray-900 dark:text-white mb-2">User ID Required</h2>
					<p className="text-gray-500 mb-4">Please provide a user_id in the URL query parameters.</p>
					<code className="bg-gray-100 dark:bg-gray-900 px-2 py-1 rounded text-sm">?user_id=...</code>
				</div>
			</div>
		);
	}
