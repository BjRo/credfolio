			...
			{tailoring && (
				<div className="mb-8 p-6 bg-green-50 dark:bg-green-900/20 rounded-xl border border-green-100 dark:border-green-900">
					...
					<p className="text-gray-700 dark:text-gray-300 italic text-lg leading-relaxed">
						"{tailoring.summary_highlights}"
					</p>
				</div>
			)}

			<div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-8 border border-gray-100 dark:border-gray-700">
				<h2 className="text-2xl font-bold mb-8 text-gray-900 dark:text-white border-b border-gray-100 dark:border-gray-700 pb-4">
					Professional Experience
				</h2>
				<ExperienceList
					companies={profile.companies}
					highlightSkillIDs={tailoring?.relevant_skill_ids}
				/>
			</div>
		</div>
	);
