...
export default function ExperienceList({ companies, highlightSkillIDs }: { companies: any[]; highlightSkillIDs?: string[] }) {
			...
			{companies.map((company) => (
				<div key={company.id} className="relative pl-8 md:pl-0">
					<div className="md:flex items-center justify-between mb-4 md:mb-0 md:flex-row-reverse group">
						{/* Dot */}
						<div className="absolute left-5 md:left-1/2 -translate-x-1/2 w-4 h-4 rounded-full bg-blue-500 border-4 border-white dark:border-gray-900 shadow-sm"></div>
